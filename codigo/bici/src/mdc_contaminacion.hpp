 ...
 * GPIO11   |
 * +--------------+---------+-------+----------+----------+----------+----------+----------+
 * | CLK_PIN(SCLK)| GPIO14  | GPIO18| GPIO36   | GPIO12   | GPIO4    | GPIO21 |
 * GPIO10   |
 * +--------------+---------+-------+----------+----------+----------+----------+----------+
...
// readFile: imprime en el terminal los contenidos de un archivo con el path
// indicado
...
// writeFile: escribe una cadena de texto al principio del archivo en el path
// indicado
...
// appendFile: escribe una cadena de texto al final del archivo en el path
// indicado
